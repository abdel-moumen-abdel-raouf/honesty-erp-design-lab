...
describe('ErpTimeBox', () => {
  ...
  it('commits only confirmed overlay time', async () => { const fixture = create(); const manager = TestBed.inject(ErpOverlayManager); const onChange = vi.fn(); fixture.componentInstance.registerOnChange(onChange); (fixture.nativeElement as HTMLElement).querySelector('button')?.click(); manager.entries()[0].ref.close('09:35'); await Promise.resolve(); expect(onChange).toHaveBeenCalledWith('09:35'); });
});
