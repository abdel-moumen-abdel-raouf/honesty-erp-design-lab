...
@Component({
  ...
  host: {
    ...
    '[class.a]': "variant() === 'outline'",
    '[class.b]': "variant() === 'subtle'",
    '[class.c]': "variant() === 'ghost'",
    '[class.d]': "variant() === 'text'",
    ...
    '[class.i]': "tone() === 'danger'",
    '[class.j]': "tone() === 'info'",
    '[class.k]': "tone() === 'neutral'",
    '[class.l]': "size() === 'sm'",
    '[class.m]': "size() === 'lg'",
    '[class.o]': "shape() === 'rounded'",
    '[class.p]': "shape() === 'pill'",
    '[class.q]': "borderStyle() === 'dashed'",
  },
})
